...
"""
    The GranulesOutputParser parses EPCIS from OPSM. Collects the data points from the 
    incoming EPCIS for use in the GranulesOutputStep.    
"""


class GranulesOutputParser(FlexibleNSParser):
    """
        ctor
    """
    ...
    def __init__(self, data):
        ...
        temp = env.get_template('granules/granules_object_event.xml')
        self._template = temp
        # call the base constructor with the stream
        super(GranulesOutputParser, self).__init__(stream=data)
